...
export default function ProblemsPage() {
  ...
  const deletePlatformMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "All problems from the platform have been removed.",
      });
      setDeleteConfirm({ ...deleteConfirm, isOpen: false });
    },
    onError: () => {
  ...
  const deleteAllMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "All problems have been removed successfully.",
      });
      setDeleteConfirm({ ...deleteConfirm, isOpen: false });
    },
    onError: () => {
  ...
  const updateDifficultyMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "The problem difficulty has been updated.",
      });
    },
    onError: () => {
      toast({
  ...
  const filteredProblems = problems.filter((problem) => {
    ...
    const matchesCategory = categoryFilter === "" || (problem.category && problem.category.toLowerCase().includes(categoryFilter.toLowerCase()));
